...
{
    public class CatchModWiggle : ModWithVisibilityAdjustment
    {
        ...
        {
            var osuObject = (CatchHitObject)drawable.HitObject;
            ...
            if (osuObject is JuiceStream || osuObject is BananaShower)
                return;
